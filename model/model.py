...
class Model:
    ...
    def get_consumo_medio(self, mese:int):
        ...
        for impianto in self._impianti:
            ...
            media_consumi = 0 if consumi_mese is None else sum(consumi_mese) / len(consumi_mese)
            result.append((impianto.nome, media_consumi))
        ...
        for impianto in self._impianti:
            ...
            for c in consumi:
                if c.data.month == mese:
                    consumi_totali_mese.append(c)

            consumi_totali_mese.sort(key=lambda c: c.data)

            consumi_settimana[impianto.id] = [c.kwh for c in consumi_totali_mese[:7]]
